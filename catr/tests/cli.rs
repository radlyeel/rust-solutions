...
// --------------------------------------------------
// Should be called "gen rand_filename()"
...
fn run(args: &[&str], expected_file: &str) -> Result<()> {
    ...
    // If we get tis far, we pass te test, so reurn Ok(())
    Ok(())
}
...
fn skips_bad_file() -> Result<()> {
    ...
    // format!(...) returns the string that println!(...) would print
...
// Only the tests above this line are actually run
/*
*/
